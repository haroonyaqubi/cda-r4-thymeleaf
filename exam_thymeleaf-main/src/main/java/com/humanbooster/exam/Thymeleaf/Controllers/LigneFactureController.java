...
public class LigneFactureController {
    ...
    public ModelAndView ligneFacture(@PathVariable(required = false) Facture facture){
        ...
        ModelAndView mv = new ModelAndView("factures/list.html");
        mv.addObject("ligneFacture", facture);
        return mv;
    }

    @RequestMapping(value = "ligne/{facture}/add", method = RequestMethod.GET)
    public ModelAndView form(@PathVariable(required = false) Facture facture){
        ...
        ModelAndView mv = new ModelAndView("factures/add");
    ...
    @RequestMapping(value = "ligne/{facture}/add", method = RequestMethod.POST)
